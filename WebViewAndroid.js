...
export default class WebViewAndroid extends React.Component {
    static propTypes = {
        ...
        /**
         * Sets the user-agent for this WebView. The user-agent can also be set in libs using
         ...
         * 是否允许拦截url
         */
        allowInterceptUrl:PropTypes.bool,

        /**
         * 拦截url的匹配的数组
         */
        injectFilterInterceptArray:PropTypes.array,
    ...
    render() {
        ...
        if (this.state.viewState === WebViewState.LOADING) {
            ...
            console.error('CRCTWebView invalid state encountered: ' + this.state.loading);
        }
    ...
    goForward = () => {
        UIManager.dispatchViewManagerCommand(
            ...
            UIManager.CRCTWebView.Commands.goForward,
            null
        );
    };
    ...
    goBack = () => {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.CRCTWebView.Commands.goBack,
            null
        );
    };
    ...
    reload = () => {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.CRCTWebView.Commands.reload,
            null
        );
    };
    ...
    stopLoading = () => {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.CRCTWebView.Commands.stopLoading,
            null
        );
    };
    ...
    postMessage = (data) => {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.CRCTWebView.Commands.postMessage,
            [String(data)]
        );
    };
    ...
    injectJavaScript = (data) => {
        UIManager.dispatchViewManagerCommand(
            this.getWebViewHandle(),
            UIManager.CRCTWebView.Commands.injectJavaScript,
            [data]
        );
    };
...
var CRCTWebView = requireNativeComponent('CRCTWebView', WebViewAndroid, {
    nativeOnly: {
