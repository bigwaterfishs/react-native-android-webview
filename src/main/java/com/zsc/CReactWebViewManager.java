 ...
 */
@ReactModule(name = CReactWebViewManager.REACT_CLASS)
public class CReactWebViewManager extends SimpleViewManager<WebView> {

  protected static final String REACT_CLASS = "CRCTWebView";
  ...
  protected static class ReactWebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
      ...
      //************** by zhengshichao 用于Url拦截*******************//
      ReactWebView rnWebView = (ReactWebView) view;
      if (rnWebView.getAllowInterceptUrl()) {
        //事件拦截
        ReadableNativeArray nativeArray = (ReadableNativeArray) rnWebView.getInjectFilterInterceptArray();
        if (nativeArray != null && nativeArray.size() > 0) {
          if (!TextUtils.isEmpty(url)) {
            ...
            if (isIntercet) {
              dispatchEvent(rnWebView,new ShouldStartLoadWithRequestEvent(rnWebView.getId(), view.getTitle(), false, url, view.canGoBack(), view.canGoForward(),interceptValue));
              return true;
            }
          }
        }
  ...
  public CReactWebViewManager(WebViewConfig webViewConfig) {
  ...
  //****************add by zhengshichao1@jd.com****************///

  @ReactProp(name = "allowInterceptUrl")
  public void setAllowInterceptUrl(ReactWebView view, boolean enabled) {
    view.setAllowInterceptUrl(enabled);
  }

  @ReactProp(name = "injectFilterInterceptArray")
  public void setInjectFilterInterceptArray(ReactWebView view,@Nullable ReadableArray injectFilterInterceptArray){
